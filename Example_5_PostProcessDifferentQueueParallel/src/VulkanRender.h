...
public:
    ...
    VulkanQueuePtr vulkanRenderQueue1;
    VulkanQueuePtr vulkanRenderQueue2;
    ...
    std::vector<VulkanFencePtr> vulkanRenderFences1;
    std::vector<VulkanFencePtr> vulkanRenderFences2;
